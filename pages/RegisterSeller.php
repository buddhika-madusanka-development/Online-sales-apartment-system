...
<head>
    ...
    <link rel="stylesheet" href="../styles/reg-seller.css">
...
<body>
    <div class="container-reg">
        <div class="header-reg">
            ...
            <p style="text-align: center; margin: 0 auto;" class ="w-60">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto asperiores optio architecto possimus quis molestias, quaerat dolores eligendi odit aperiam, necessitatibus, aut laborum cum nobis sequi consectetur quas incidunt nihil?</p>
        </div>
        <div style="margin: 50px auto;" class="row-reg ">
            <div class="col-reg">
